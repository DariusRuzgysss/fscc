...
export {default as OMS_Logo} from './images/OMS_Blue.png';
export {default as Rounded_Arrow_Big} from './images/Rounded_Arrow_Big.png';
export {default as Rounded_Ornament} from './images/Rounded_ornament.png';
